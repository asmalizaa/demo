...
public class GreetingController {
	...
	public Integer addTwoNumbers(@PathVariable("num1") Integer num1, @PathVariable("num2") Integer num2) {
		return num1 + num2;
	}

	@GetMapping("/sub/{num1},{num2}")
	public Integer subTwoNumbers(@PathVariable("num1") Integer num1, @PathVariable("num2") Integer num2) {
		return num1 - num2;
	}
}
